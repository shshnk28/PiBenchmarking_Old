...
//	public static Logger LOG = LoggerFactory.getLogger(CsvSplitter.class);
	...
	public static List<TableClass> roundRobinSplitCsvToMemory(String inputSortedCSVFileName, int numThreads, double accFactor, String datasetType) throws IOException, URISyntaxException{
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		switch(args.length){
			...
			case 0: numThreads = defaultNumThreads;
					peakRate = defaultPeakRate; break;
			default:
//				LOG.warn("Invalid Number of Arguments! args = numThreads peakRate"); return ;
		}
